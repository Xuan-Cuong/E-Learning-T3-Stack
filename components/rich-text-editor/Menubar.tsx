...
import { AlignCenter, AlignLeft, AlignRight, Bold, Heading1Icon, Heading2Icon, Heading3Icon, HeadingIcon, Italic, List, ListIcon, ListOrderedIcon, Redo, Strikethrough, Undo } from "lucide-react";
...
export function Menubar({ editor }: iAppProps) {
    if (!editor) {
        ...
        <div className="border border-input border-t-0 border-x-0 rounded-t-lg p-2 
        bg-card flex flex-wrap gap-1 items-center">
            <TooltipProvider>
